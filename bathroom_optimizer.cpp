...
// Function to label locations based on coordinates
...
int main() {
    ...
    for (const auto& bathroom : existingBathrooms) {
        std::cout << "(" << bathroom.x << ", " << bathroom.y << ") with traffic: " << bathroom.traffic << " (Near: " << labelLocation(bathroom.x, bathroom.y) << ")\n";
    }
    std::cout << "Hotspots:\n";
    for (const auto& hotspot : hotspots) {
        std::cout << "(" << hotspot.x << ", " << hotspot.y << ") with traffic: " << hotspot.traffic << " (Near: " << labelLocation(hotspot.x, hotspot.y) << ")\n";
    }
    std::cout << "\n";
